        ...
        >
          ...
          <div className="lg:col-span-7 text-left space-y-6">
            ...
            <motion.h1 
              ...
              className="text-5xl sm:text-6xl md:text-7xl font-black tracking-tight text-slate-900 dark:text-white font-display leading-[0.95]"
            >
              Nilesh Kumar
            </motion.h1>
...
{/* Profile Picture (Right) */}
  ...
  >
    <Badge variant="primary" className="bg-white border-slate-200 text-slate-750 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-300 shadow-xl px-3.5 py-1.5 font-bold hover:scale-110 transition-transform">
      MongoDB
    </Badge>
  </motion.div>
  ...
  >
    <Badge variant="accent" className="shadow-xl px-3.5 py-1.5 font-bold hover:scale-110 transition-transform">
      Gemini AI
    </Badge>
  </motion.div>
      </div>
